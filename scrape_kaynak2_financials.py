"""
Kaynak 2 Finansal Veri Scraper
...
JS_CODE = r"""export default async ({ page }) => {
  await page.setCookie(
    { name: "CHASESSID", value: "SESS", domain: ".kaynak2.com", path: "/" },
    { name: "CHARC",     value: "CHARC_V", domain: ".kaynak2.com", path: "/" }
  );
  
  await page.goto("https://www.kaynak2.com/airlines/SLUG#financials", 
...
if __name__ == "__main__":
    ...
    out = "/Users/emre/Desktop/haberozetleri/cha_financials.json"
