"""
CH Aviation fleet scraper — tüm 21 havayolu
Kaynak: https://www.ch-aviation.com/airlines/{IATA}#fleetsBases
"""
...
def build_js(iata):
    return (
        ...
        '    { name: "CHASESSID", value: "' + CHASESSID + '", domain: ".ch-aviation.com", path: "/" },\n'
        '    { name: "CHARC",     value: "' + CHARC     + '", domain: ".ch-aviation.com", path: "/" },\n'
        '    { name: "__cf_bm",   value: "' + CF_BM     + '", domain: ".ch-aviation.com", path: "/" }\n'
        '  );\n'
        '  await page.goto("https://www.ch-aviation.com/airlines/' + iata + '#fleetsBases", {\n'
...
if __name__ == "__main__":
    ...
    out = "/Users/emre/Desktop/haberozetleri/.claude/worktrees/cool-galileo-8eb736/chaviation_data.json"
